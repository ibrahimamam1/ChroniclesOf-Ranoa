...
public class UImanager {
  ...
  public void drawChooseLevel(Graphics2D g2) {
  ...
  public void drawIntroScreen(Graphics2D g2) {
    ...
    String text = "By The Power Of The Ancient Lords ,";
    int x = getXForCenteredText(text);
    int y = gp.tileSize*3;
    g2.drawString(text , x , y);

    text = "The Great Hero was Summoned to mysticiya";
    x = getXForCenteredText(text);
    y += gp.tileSize;
    g2.drawString(text, x, y);

    text = "The Land Where Darkness and evil prevails.";
    x = getXForCenteredText(text);
    y += gp.tileSize;
    g2.drawString(text, x, y);

    text = "Our Hero needs to brave his sword ";
    x = getXForCenteredText(text);
    y += gp.tileSize;
    g2.drawString(text, x, y);

    text = "And save the world from evil";
    x = getXForCenteredText(text);
    y += gp.tileSize;
    g2.drawString(text, x, y);
